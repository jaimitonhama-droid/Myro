...
const playlistId = "PL-AZkpCx_bCBdOfDYb2VyE475iOqVUz_k";

async function addMoreMusics() {
  ...
  try {
    ...
    console.log(`Todos os vídeos da playlist foram adicionados com sucesso à categoria Músicas!`);
    process.exit(0);
