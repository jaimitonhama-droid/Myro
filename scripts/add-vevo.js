...
const playlistId = "PLGbPDbpr3HZ-nOqSAqrxt74fqIKe2L-e6";

async function addVevoMusics() {
  ...
  try {
    ...
    console.log(`Todos os vídeos da playlist foram adicionados com sucesso à categoria VEVO!`);
    process.exit(0);
