...
const playlistId = "PLD5sM5sCg8SpsfVX5_QF1qSJq78tSL-v0";

async function addPhonkMusics() {
  ...
  try {
    ...
    console.log(`Todos os vídeos da playlist foram adicionados com sucesso à categoria Phonk!`);
    process.exit(0);
